...
class GameCam(arcade.camera.Camera):
    ...
    def center_camera_on_player(self):
        ...
        if screen_center_y < 0:
            screen_center_y = 0
        if screen_center_x > constants.MAP_WIDTH - self.viewport_width:
            screen_center_x = constants.MAP_WIDTH - self.viewport_width
        if screen_center_y > constants.MAP_HEIGHT - self.viewport_height:
            screen_center_y = constants.MAP_HEIGHT - self.viewport_height
